...
/**
 * Created by lijunying on 17/1/23.
 */
...
/**
 *网站安全检测调用示例代码 － 聚合数据
 *在线接口文档：http://www.juhe.cn/docs/19
 **/

public class UrlSecrityCheck {
    ...
    //1.网站安全检测
    public static String getCheckResult(String anaUrl) throws Exception {
        String result = null;
